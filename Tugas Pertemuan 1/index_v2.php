...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Najwa Armia Zahra"; ?></p>
        ...
        //Variabel $alamat_perpus dan $telepon_perpus
        $alamat_perpus   = "Jl. Pendidikan No.10 Pekalongan";
        $telepon_perpus  = "(0285) 123456";
        // Variabel $jam_buka dan $jam_tutup untuk jam operasional
        $jam_buka = "08.00";
        $jam_tutup = "16.00";
        $total_buku    = 1250;
        $total_anggota = 450;
        ...
        <!-- Card Baru INFORMASI PERPUSTAKAAN -->
        <div class="info">
